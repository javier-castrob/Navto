sap.ui.define([
    ...
    function (Controller, History, JSONModel) {
        ...
        return Controller.extend("EjemploNavTo.EjemploNavTo.controller.Vista3", {
            onInit: function () {
                this.getOwnerComponent().getRouter().getRoute("RouteVista3").attachPatternMatched(this._añadirTextModel, this);
            },
